\documentclass[a4paper,14pt,twocolumn,twoside]{article}
\usepackage[german,polish]{babel}  %paczka stosowana w przypadku stosowania wielu języków
\usepackage[utf8]{inputenc} %ustawianie kodowania
\usepackage[T1]{fontenc}    %sposób kodowania fontów w pliku wyjściowym
\usepackage{graphicx} 
\usepackage{anysize}
\usepackage{enumerate} %wylistowania
